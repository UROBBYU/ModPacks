...
recipes.addShaped(<appliedenergistics2:item.ToolNetworkTool>, [[<appliedenergistics2:item.ToolCertusQuartzWrench>.giveBack(<appliedenergistics2:item.ToolCertusQuartzWrench>), <ore:itemIlluminatedPanel>, <appliedenergistics2:item.ItemMultiMaterial:23>], [<minecraft:chest>, null, null]]);

#presses in rolling maching
