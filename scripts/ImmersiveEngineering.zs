...
#recipes.addShaped(<ImmersiveEngineering:tool>, [[null, <ore:ingotIron>, <minecraft:string>], [null, <ore:treatedStick>, <ore:ingotIron>], [<ore:treatedStick>, null, null]]);

#sand-dust crusher recipe
mods.immersiveengineering.Crusher.addRecipe(<exnihilo:dust> * 1, <minecraft:sand>, 1600);
