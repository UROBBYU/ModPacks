...
recipes.addShaped(<ThermalExpansion:Device:3>, [[null, <minecraft:iron_pickaxe>, null], [<ore:gearTin>, <minecraft:piston>, <ore:gearTin>], [null, <ThermalExpansion:material>, null]]);
...
#ore exchange
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:gold_dust> * 4, <minecraft:gold_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:silver_dust> * 4, <ThermalFoundation:Ore:2>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:copper_dust> * 4, <ThermalFoundation:Ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:tin_dust> * 4, <ThermalFoundation:Ore:1>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:lead_dust> * 4, <ThermalFoundation:Ore:3>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:nickel_dust> * 4, <ThermalFoundation:Ore:4>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:platinum_dust> * 4, <ThermalFoundation:Ore:5>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:iron_dust> * 4, <minecraft:iron_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exastris:draconiumdust_dust> * 4, <DraconicEvolution:draconiumOre>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <aobd:oreDustDraconium> * 4, <DraconicEvolution:draconiumOre>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <exnihilo:aluminum_dust> * 4, <TConstruct:SearedBrick:5>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <aobd:oreDustAluminium> * 4, <TConstruct:SearedBrick:5>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <aobd:oreDustUranium> * 4, <IC2:blockOreUran>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <aobd:oreDustYellorium> * 4, <BigReactors:YelloriteOre>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:netherrack>, <aobd:oreDustCobalt> * 4, <TConstruct:SearedBrick:1>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:netherrack>, <exastris:CobaltOreBlock> * 4, <TConstruct:SearedBrick:1>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:netherrack>, <aobd:oreDustArdite> * 4, <TConstruct:SearedBrick:2>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:netherrack>, <exastris:ArditeOreBlock> * 4, <TConstruct:SearedBrick:2>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:netherrack>, <minecraft:quartz_block> * 2, <minecraft:quartz_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <minecraft:lapis_block>, <minecraft:lapis_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <minecraft:diamond_block>, <minecraft:diamond_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <minecraft:redstone_block>, <minecraft:redstone_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <minecraft:emerald_block>, <minecraft:emerald_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <minecraft:coal_block>, <minecraft:coal_ore>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <appliedenergistics2:tile.BlockQuartz>, <appliedenergistics2:tile.OreQuartz>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <Forestry:resourceStorage>, <Forestry:resources>);
mods.thermalexpansion.Smelter.addRecipe(20000, <minecraft:stone>, <ProjRed|Exploration:projectred.exploration.stone:11>, <ProjRed|Exploration:projectred.exploration.ore:6>);
