...
//
// Re-Enabled for FTB Infinity Skyblock!
//
...
# - Skyblock Tweaks (Ex-Nihlio)
# -- Thaumcraft fire shard output increase
mods.exnihilo.Hammer.removeRecipe(<minecraft:nether_brick>);
mods.exnihilo.Hammer.addRecipe(<minecraft:nether_brick>, [<Thaumcraft:ItemShard:1>, <Thaumcraft:ItemShard:1>, <Thaumcraft:ItemShard:1>, <Thaumcraft:ItemShard:1>], [1, 1, 1, 1], [0, 0, 0, 0]);
