...
recipes.addShaped(<DraconicEvolution:draconiumChest>, [[<minecraft:obsidian>, <minecraft:obsidian>, <minecraft:obsidian>], [<IronChest:BlockIronChest:6>, <DraconicEvolution:draconium>, <IronChest:BlockIronChest:6>], [null, <IC2:itemRTGPellet>, null]]);
...
recipes.addShaped(<DraconicEvolution:draconicAxe>, [[<DraconicEvolution:awakenedCore>, <ore:blockElectrumFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <ExtraUtilities:defoliageAxe>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicHoe>, [[<DraconicEvolution:awakenedCore>, <ore:blockElectrumFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <ExtraUtilities:temporalHoe>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicBow>, [[<DraconicEvolution:awakenedCore>, <ore:blockElectrumFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernBow>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicSword>, [[<DraconicEvolution:awakenedCore>, <ore:blockElectrumFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernSword>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicShovel>, [[<DraconicEvolution:awakenedCore>, <ore:blockElectrumFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernShovel>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicPickaxe>, [[<DraconicEvolution:awakenedCore>, <ore:blockElectrumFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernPickaxe>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
...
recipes.addShaped(<DraconicEvolution:draconicHelm>, [[<DraconicEvolution:awakenedCore>, <ore:blockCrystalFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernHelm>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicChest>, [[<DraconicEvolution:awakenedCore>, <ore:blockCrystalFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernChest>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicLeggs>, [[<DraconicEvolution:awakenedCore>, <ore:blockCrystalFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernLeggs>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
recipes.addShaped(<DraconicEvolution:draconicBoots>, [[<DraconicEvolution:awakenedCore>, <ore:blockCrystalFlux>, <DraconicEvolution:awakenedCore>], [<ExtraUtilities:pureLove>, <DraconicEvolution:wyvernBoots>, <ExtraUtilities:pureLove>], [<DraconicEvolution:draconicBlock>, <DraconicEvolution:draconiumEnergyCore:1>, <DraconicEvolution:draconicBlock>]]);
...
//smeltery recipes
mods.tconstruct.Smeltery.addAlloy(<liquid:mana> * 288, [<liquid:xpjuice> * 1000, <liquid:draconium> * 288]);
...
//green heart
recipes.addShapeless(<TConstruct:heartCanister:5>, [<ForbiddenMagic:StarBlock>, <StevesCarts:BlockMetalStorage:2>, <IC2:itemPartIridium>, <ExtraUtilities:block_bedrockium>]);
